...
class _MonthScreenState extends State<MonthScreen> {
  ...
  bool showSuccessModal = false; // Thêm biến này
  ...
  Future<void> updateOrAddAttendance() async {
    ...
    final attendanceList = selectedEmployee['attendance'] as List? ?? [];
    final existingAttendance = attendanceList.firstWhere(
    ...
    try {
      ...
      if (existingAttendance != null) {
        // Use PUT for updateAttendance
        final endpoint = '/updateAttendance';
        ...
        // Use POST for addAttendance
        final endpoint = '/addAttendance';
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          showSuccessModal = true; // Hiển thị modal thành công
        });

        // Thêm thông báo thành công (SnackBar vẫn giữ lại nếu muốn)
        ...
        print(
          'Failed to update/add attendance. Server responded with ${response.statusCode}: ${response.body}',
        );
      }
    } catch (error) {
      print('Error updating/adding attendance: $error');
    }
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (showSuccessModal) _buildSuccessModal(), // Thêm dòng này
        ],
      ),
    );
  }
    ...
    return Positioned.fill(
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Center(
            child: GestureDetector(
              onTap: () {}, // Ngăn sự kiện tap lan xuống modal content
              child: Container(
                width: MediaQuery.of(context).size.width * 0.8,
                padding: EdgeInsets.all(20),
                decoration: BoxDecoration(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    // Nút đóng đã bị ẩn đi, chỉ đóng khi bấm ra ngoài
                    // ElevatedButton(
                    //   style: ElevatedButton.styleFrom(
                    //     backgroundColor: Color(0xFF5e749e),
                    //   ),
                    //   onPressed: () => setState(() => showSuccessModal = false),
                    //   child: Text(
                    //     'Đóng',
                    //     style: TextStyle(color: Colors.white, fontFamily: 'HP101'),
                    //   ),
                    // ),
                  ],
                ),
